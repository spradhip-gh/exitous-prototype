      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        {resources.length === 0 && (
          <Card className="flex flex-col items-center justify-center p-12 text-center">
            ...
            <h2 className="text-xl font-semibold">No Company Resources</h2>
            <p className="text-muted-foreground mt-2">Your company has not uploaded any documents yet. Please check back later.</p>
          </Card>
        )}
