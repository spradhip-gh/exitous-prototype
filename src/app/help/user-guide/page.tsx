            ...
            <div className="container mx-auto py-12 px-4">
                <article className="prose lg:prose-xl max-w-4xl mx-auto">
                    ...
                    <Alert>
                        ...
                        <AlertDescription>
                            All the information you enter in your Profile and Exit Details is stored securely and is not shared with your employer. It is used only to generate your personalized recommendations.
                        </AlertDescription>
                    </Alert>
                    ...
                    <ul>
                        ...
                        <li><strong>Personalized Next Steps:</strong> This is a list of tasks and helpful tips, sorted by urgency, to help you navigate your exit. This list is generated by a combination of deterministic rules and an AI agent to be as relevant as possible. You can check items off as you complete them to track your progress.</li>
                    ...
                    <p>
                        From the sidebar navigation, you can go to **Account Settings** to update your personal email address and phone number for notifications. If you need to clear all your entered data and start the process again, you can click on your email in the top-right corner of the page and select **Start Over**.
                    </p>
