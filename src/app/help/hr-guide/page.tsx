            ...
            <div className="container mx-auto py-12 px-4">
                <article className="prose lg:prose-xl max-w-4xl mx-auto">
                    ...
                    <ul>
                        ...
                        <li><strong>Deadline Defaults:</strong> Set the default time and timezone for severance agreement deadlines. This ensures consistency and accuracy for date-sensitive recommendations generated by the AI.</li>
                    </ul>
