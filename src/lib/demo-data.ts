...
`
        ...
        masterTasks: [
            // Basics
            { id: 'review-separation-documents', type: 'layoff', name: 'Review Separation Documents', category: 'Basics', detail: 'Carefully read your official separation notice and any other documents provided by HR. Pay close attention to key dates, deadlines, and contact information.', deadlineType: 'notification_date', deadlineDays: 1 },
            { id: 'backup-work-files', type: 'layoff', name: 'Backup Personal Files & Contacts', category: 'Basics', detail: 'Before you lose access, save any personal files, contacts, and performance reviews from your work computer to a personal device or cloud storage. Do not take any company-owned data.', deadlineType: 'termination_date', deadlineDays: 0 },
            { id: 'return-company-property', type: 'layoff', name: 'Plan to Return Company Property', category: 'Basics', detail: 'Coordinate with your manager or HR to return all company property, such as your laptop, phone, and security badge, by the required deadline.', deadlineType: 'termination_date', deadlineDays: 1 },
            // Financial
            { id: 'apply-for-unemployment', type: 'layoff', name: 'Apply for Unemployment Benefits', category: 'Financial', detail: 'Visit your state\'s unemployment website and file a claim. This can usually only be done after your final day of employment.', deadlineType: 'termination_date', deadlineDays: 1 },
            { id: 'create-transition-budget', type: 'layoff', name: 'Create a Transition Budget', category: 'Financial', detail: 'Analyze your income, savings, and expenses to create a budget that will see you through your job search. Identify areas where you can cut back if necessary.', deadlineType: 'notification_date', deadlineDays: 7 },
            { id: 'understand-401k-options', type: 'layoff', name: 'Understand Your 401(k) Options', category: 'Financial', detail: 'Contact your 401(k) provider to understand your options, which may include rolling it over to an IRA, leaving it in the plan (if the balance is high enough), or cashing it out (which has tax implications).', deadlineType: 'notification_date', deadlineDays: 30, linkedResourceId: 'fin-1' },
            { id: 'check-pto-payout', type: 'layoff', name: 'Check on Final Paycheck & PTO Payout', category: 'Financial', detail: 'Confirm with HR when you will receive your final paycheck and whether you will be paid out for any unused Paid Time Off (PTO), as this varies by state and company policy.', deadlineType: 'termination_date', deadlineDays: 7 },
            { id: 'consult-tax-advisor', type: 'layoff', name: 'Consult a Tax Advisor', category: 'Financial', detail: 'A layoff can have significant tax implications, from severance pay to stock options. A tax professional can help you plan accordingly.', deadlineType: 'notification_date', deadlineDays: 60, linkedResourceId: 'fin-2' },
            // Legal
            { id: 'review-severance-agreement', type: 'layoff', name: 'Review Severance Agreement', category: 'Legal', detail: 'Carefully read your severance agreement. It is highly recommended to have an employment lawyer review it before signing, as you may be waiving important rights.', deadlineType: 'notification_date', deadlineDays: 21, linkedResourceId: 'legal-1' },
            { id: 'handle-work-visa-implications', type: 'layoff', name: 'Consult an Immigration Attorney', category: 'Legal', detail: 'If you are on a work visa, your legal status is tied to your employment. It is critical to consult an immigration attorney immediately to understand your grace period and options.', deadlineType: 'notification_date', deadlineDays: 3, linkedResourceId: 'legal-2' },
            // Health
            { id: 'explore-health-insurance', type: 'layoff', name: 'Explore Health Insurance Options', category: 'Health', detail: 'Research your options for health insurance to avoid a coverage gap. This includes COBRA, ACA marketplace plans, or joining a spouse\'s plan. Pay close attention to enrollment deadlines.', deadlineType: 'termination_date', deadlineDays: 14, linkedResourceId: 'well-2' },
            { id: 'schedule-medical-appointments', type: 'layoff', name: 'Schedule Necessary Medical Appointments', category: 'Health', detail: 'If you have upcoming medical, dental, or vision needs, try to schedule appointments before your current insurance coverage ends.', deadlineType: 'termination_date', deadlineDays: -7 },
            // Career
            { id: 'update-resume-and-linkedin', type: 'layoff', name: 'Update Resume & LinkedIn', category: 'Career', detail: 'Update your resume and LinkedIn profile to reflect your latest accomplishments and skills. Tailor your resume for each job application.', deadlineType: 'notification_date', deadlineDays: 3, linkedResourceId: 'job-1' },
            { id: 'start-networking', type: 'layoff', name: 'Start Networking', category: 'Career', detail: 'Begin reaching out to your professional network to let them know you are looking for a new role. Informational interviews can be a great way to explore opportunities.', deadlineType: 'notification_date', deadlineDays: 7, linkedResourceId: 'job-3' },
            { id: 'request-recommendations', type: 'layoff', name: 'Request Recommendations', category: 'Career', detail: 'Ask trusted colleagues or managers for recommendations on LinkedIn or if they would be willing to serve as a reference.', deadlineType: 'termination_date', deadlineDays: 14 },
            { id: 'practice-interviewing', type: 'layoff', name: 'Practice Interviewing', category: 'Career', detail: 'Prepare for interviews by practicing common questions and developing your "STAR" method stories (Situation, Task, Action, Result).', deadlineType: 'notification_date', deadlineDays: 14, linkedResourceId: 'job-1' },
            { id: 'seek-emotional-support', type: 'layoff', name: 'Seek Emotional Support', category: 'Health', detail: 'Losing a job can be stressful. Don\'t hesitate to lean on friends, family, or a mental health professional for support during this transition.', deadlineType: 'notification_date', deadlineDays: 7, linkedResourceId: 'well-1' },
        ],
        taskMappings: [
