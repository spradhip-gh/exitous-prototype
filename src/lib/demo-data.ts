...
`
        ...
        masterTasks: [
            ...
            { id: 'consult-tax-advisor', type: 'layoff', name: 'Consult a Tax Advisor', category: 'Financial', detail: 'A layoff can have significant tax implications. A tax professional can help.', deadlineType: 'notification_date', deadlineDays: 60, linkedResourceId: 'fin-2' },
            { id: 'review-severance-agreement', type: 'layoff', name: 'Review Severance Agreement', category: 'Legal', detail: 'It is highly recommended to have an employment lawyer review your severance agreement before signing.', deadlineType: 'notification_date', deadlineDays: 21, linkedResourceId: 'legal-1' },
            { id: 'handle-work-visa-implications', type: 'layoff', name: 'Consult an Immigration Attorney', category: 'Legal', detail: 'If you are on a work visa, it is critical to consult an immigration attorney immediately.', deadlineType: 'notification_date', deadlineDays: 3, linkedResourceId: 'legal-2' },
            { id: 'explore-health-insurance', type: 'layoff', name: 'Explore Health Insurance Options', category: 'Health', detail: 'Research COBRA, ACA marketplace plans, and other options to avoid a coverage gap.', deadlineType: 'termination_date', deadlineDays: 14, linkedResourceId: 'well-2' },
            ...
            { id: 'update-resume-and-linkedin', type: 'layoff', name: 'Update Resume & LinkedIn', category: 'Career', detail: 'Update your resume and LinkedIn to reflect your latest accomplishments.', deadlineType: 'notification_date', deadlineDays: 3, linkedResourceId: 'job-1' },
            { id: 'start-networking', type: 'layoff', name: 'Start Networking', category: 'Career', detail: 'Reach out to your professional network to let them know you are looking for a new role.', deadlineType: 'notification_date', deadlineDays: 7, linkedResourceId: 'job-3' },
            ...
            { id: 'practice-interviewing', type: 'layoff', name: 'Practice Interviewing', category: 'Career', detail: 'Prepare for interviews by practicing common questions and STAR method stories.', deadlineType: 'notification_date', deadlineDays: 14, linkedResourceId: 'job-1' },
            { id: 'seek-emotional-support', type: 'anxious', name: 'Seek Emotional Support', category: 'Health', detail: 'Lean on friends, family, or a mental health professional for support.', deadlineType: 'notification_date', deadlineDays: 7, linkedResourceId: 'well-1' },
        ],
        taskMappings: [
