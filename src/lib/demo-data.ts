...
`
        ...
        masterTasks: [
            { "id": "review-separation-documents", "type": "layoff", "name": "Review separation documents", "category": "Basics", "detail": "Review your official separation notice for key dates and details. The timeline may have details on your severance, benefits, and other parts of your exit.", "deadlineType": "notification_date", "deadlineDays": 2 },
            { "id": "return-company-property", "type": "layoff", "name": "Return company property", "category": "Basics", "detail": "Your company will provide instructions on how to return your laptop, phone, and other equipment.", "deadlineType": "termination_date", "deadlineDays": 14 },
            { "id": "apply-for-unemployment", "type": "layoff", "name": "Apply for unemployment benefits", "category": "Financial", "detail": "Once your employment has ended, you can apply for unemployment benefits through your state's agency. The amount and duration of benefits vary by state.", "deadlineType": "termination_date", "deadlineDays": 1 },
            { "id": "create-transition-budget", "type": "layoff", "name": "Create a transition budget", "category": "Financial", "detail": "Analyze your income sources (like severance and unemployment) and essential expenses to create a budget that will see you through your job search.", "deadlineType": "notification_date", "deadlineDays": 7 },
            { "id": "understand-401k-options", "type": "layoff", "name": "Understand your 401(k) options", "category": "Financial", "detail": "Contact your 401(k) provider to understand your options, which may include rolling it over to an IRA, leaving it in the plan, or cashing it out (which may have tax penalties).", "deadlineType": "notification_date", "deadlineDays": 30 },
            { "id": "check-final-paycheck-and-pto", "type": "layoff", "name": "Check on final paycheck & PTO payout", "category": "Financial", "detail": "Confirm with HR when you will receive your final paycheck and if you will be paid out for any unused, accrued vacation time, as policies vary by company and state.", "deadlineType": "termination_date", "deadlineDays": 7 },
            { "id": "consult-tax-advisor", "type": "layoff", "name": "Consult a tax advisor", "category": "Financial", "detail": "A layoff can have significant tax implications, especially with severance pay and 401(k) distributions. A professional can help you navigate this.", "deadlineType": "notification_date", "deadlineDays": 60, "linkedResourceId": "fin-2" },
            { "id": "review-severance-agreement", "type": "layoff", "name": "Review severance agreement", "category": "Legal", "detail": "If you are offered a severance agreement, it's highly recommended to have an employment lawyer review it before you sign. These agreements often involve waiving your right to sue.", "deadlineType": "notification_date", "deadlineDays": 21, "linkedResourceId": "legal-1" },
            { "id": "handle-work-visa-implications", "type": "layoff", "name": "Handle work visa implications", "category": "Legal", "detail": "If you are on a work visa, it is critical to consult an immigration attorney immediately to understand your grace period and options for maintaining legal status.", "deadlineType": "notification_date", "deadlineDays": 3, "linkedResourceId": "legal-2" },
            { "id": "explore-health-insurance-options", "type": "layoff", "name": "Explore health insurance options", "category": "Health", "detail": "Research your options to avoid a coverage gap. This can include COBRA, ACA marketplace plans, or joining a spouse's plan. Pay close attention to enrollment deadlines.", "deadlineType": "termination_date", "deadlineDays": 14, "linkedResourceId": "well-2" },
            { "id": "schedule-medical-appointments", "type": "layoff", "name": "Schedule necessary medical appointments", "category": "Health", "detail": "If you have pending medical or dental needs, try to schedule appointments before your current insurance coverage ends to maximize your benefits.", "deadlineType": "termination_date", "deadlineDays": -7 },
            { "id": "update-resume-and-linkedin", "type": "layoff", "name": "Update your resume & LinkedIn", "category": "Career", "detail": "Refresh your resume and LinkedIn profile to reflect your most recent accomplishments and skills. Tailor your resume for each job you apply for.", "deadlineType": "notification_date", "deadlineDays": 3, "linkedResourceId": "job-1" },
            { "id": "start-networking", "type": "layoff", "name": "Start networking", "category": "Career", "detail": "Reach out to your professional network to let them know about your situation and what kind of role you are looking for. Informational interviews can be very helpful.", "deadlineType": "notification_date", "deadlineDays": 7, "linkedResourceId": "job-3" },
            { "id": "request-recommendations", "type": "layoff", "name": "Request recommendations", "category": "Career", "detail": "Ask trusted colleagues or managers if they would be willing to provide a recommendation on LinkedIn or serve as a reference for future job applications.", "deadlineType": "termination_date", "deadlineDays": 14 },
            { "id": "practice-interviewing", "type": "layoff", "name": "Practice interviewing", "category": "Career", "detail": "Prepare for interviews by practicing common questions and developing stories that highlight your skills using the STAR (Situation, Task, Action, Result) method.", "deadlineType": "notification_date", "deadlineDays": 14, "linkedResourceId": "job-1" }
        ],
        taskMappings: [
