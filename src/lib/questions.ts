...
export interface Question {
    ...
    projectAnswerGuidance?: Record<string, Record<string, { tasks?: string[], tips?: string[], noGuidanceRequired?: boolean }>>;
    projectIds?: string[];
}
...
export const getDefaultProfileQuestions = (): Question[] => [
    ...
    },
    {
        ...
        description: 'Used for important SMS alerts if you opt-in.',
        sortOrder: 1,
    },
    { 
        id: 'maritalStatus', 
